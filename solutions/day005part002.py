# ADVENT OF CODE 2022: DAY 005 PART 002
# 
...
# from the top of the stacks together.
#
...
for instruction in instructions.split("\n"):
    ...
    crates_to_move = stacks[section_from][-amount_to_move:]
    for crate in crates_to_move:
        stacks[section_to].append(crate)
    del stacks[section_from][-amount_to_move:]
